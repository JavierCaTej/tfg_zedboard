...
#
# tfg_zedboard_project.tcl: Tcl script for re-creating project 'tfg_zedboard'
#
# Generated by Vivado on Thu Apr 23 20:28:11 CEST 2026
...
#
# 1. This project restoration tcl script (tfg_zedboard_project.tcl) that was generated.
#
...
#
#    "/home/javier/tfg/tfg_zedboard/hw/ip/tfg_axi_lite_regs_1_0/tb/tb_tfg_axi_lite_regs_v1_0_behav.wcfg"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../ip/tfg_axi_lite_regs_1_0/tb/tb_tfg_axi_lite_regs_v1_0_behav.wcfg"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "tfg_zedboard"
...
set script_file "tfg_zedboard_project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../tfg_zedboard"]"
...
set_property -name "top" -value "tfg_zedboard_bd_wrapper" -objects $obj
...
set file "$origin_dir/../../ip/tfg_axi_lite_regs_1_0/tb/tb_tfg_axi_lite_regs_v1_0_behav.wcfg"
...
# Proc to create BD tfg_zedboard_bd
proc cr_bd_tfg_zedboard_bd { parentCell } {
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.739618",
   "Default View_TopLeft":"-23,-231",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1380 -y 80 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1380 -y 100 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -x 450 -y 160 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 3 -x 850 -y 280 -defaultsOSRD
preplace inst const_1b_1 -pg 1 -lvl 2 -x 450 -y 360 -defaultsOSRD
preplace inst tfg_axi_lite_regs_0 -pg 1 -lvl 1 -x 130 -y 320 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 4 -x 1210 -y 500 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 660 240n
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 30 160 230 20 670 180 1050
preplace netloc const_1b_1_dout 1 2 1 670 320n
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 4 30 420 NJ 420 NJ 420 1030
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 3 1 1040 300n
preplace netloc processing_system7_0_DDR 1 2 3 NJ 80 NJ 80 N
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ 100 NJ 100 N
preplace netloc processing_system7_0_M_AXI_GP0 1 2 2 NJ 140 1060
preplace netloc ps7_0_axi_periph_M00_AXI 1 0 5 20 430 NJ 430 660J 380 NJ 380 1360
levelinfo -pg 1 0 130 450 850 1210 1380
pagesize -pg 1 -db -bbox -sgen 0 -80 1500 620
"
}
...
# End of cr_bd_tfg_zedboard_bd()
cr_bd_tfg_zedboard_bd ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files tfg_zedboard_bd.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files tfg_zedboard_bd.bd ] 
set_property IS_ENABLED "1" [get_files tfg_zedboard_bd.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files tfg_zedboard_bd.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files tfg_zedboard_bd.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files tfg_zedboard_bd.bd ] 
set_property PFM_NAME "" [get_files tfg_zedboard_bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files tfg_zedboard_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files tfg_zedboard_bd.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files tfg_zedboard_bd.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files tfg_zedboard_bd.bd ] 
set_property USED_IN_SIMULATION "1" [get_files tfg_zedboard_bd.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files tfg_zedboard_bd.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse tfg_zedboard_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../tfg_zedboard/tfg_zedboard.gen/sources_1/bd/tfg_zedboard_bd/hdl/tfg_zedboard_bd_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse tfg_zedboard_bd.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tfg_zedboard.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/tfg_zedboard.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tfg_zedboard.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
